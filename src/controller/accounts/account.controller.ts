...
import {ApiInternalServerErrorResponse, ApiNotFoundResponse, ApiOperation, ApiQuery, ApiTags} from "@nestjs/swagger";
...
export class AccountController {
    ...
    async changeStatus(
        @Param('id', ParseUUIDPipe) id: string,
        @Query('active') active: boolean): Promise<Account> {
